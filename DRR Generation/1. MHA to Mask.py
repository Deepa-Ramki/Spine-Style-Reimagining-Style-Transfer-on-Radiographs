...
# crop to standard shape (scale x scale x scale) (keep pixel scale consistency)
...
if __name__ == '__main__':
    ...
    root_path = "C:/Dharshu/College/FYP/Code/PerX2CT-main/mhd/"
    save_root_path = "C:/Dharshu/College\FYP\Code\PerX2CT-main\MHD_HDF5_CT2"
    files_list = glob.glob(root_path + '*.mha')
